...
export default class SpeedrunDotCom extends Resolver {
	...
	processUserPBs(data, ctx) {
		...
		const avatar = user.assets?.image?.uri || null;
		...
		return {
			...
			short: this.builder()
				.setLogo(avatar, {sfw: true, aspect: 1})
				.setTitle(title)
...
SpeedrunDotCom.hosts = ['speedrun.com'];
SpeedrunDotCom.examples = [
	{title: 'Runs', url: 'https://www.speedrun.com/portal_2#Cooperative_Game'},
	{title: 'User', url: 'https://www.speedrun.com/user/milk'}
];
