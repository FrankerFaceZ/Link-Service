...
import {galleryToken, iconToken, imageToken, linkToken, overlayToken, refToken, styleToken} from '../builder';
			...
			fragments: {
				...
				media: this.builder()
					.addConditional(
						...
						{
							type: 'player',
							iframe: `https://www.tiktok.com/embed/v2/${data.embed_product_id}`,
							aspect: data.thumbnail_width / data.thumbnail_height,
