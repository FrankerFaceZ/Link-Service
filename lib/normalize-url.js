...
function normalizeURL(url, base, default_scheme = 'http') {
	...
	// Actually, don't do this. Sorting will cause serialization differences
	// that some websites are sensitive to.
	// While the people working on the spec don't consider this a problem,
	// here in the real world this causes problems.
...
export function removeTracking(url) {
	if ( !(url instanceof URL) )
